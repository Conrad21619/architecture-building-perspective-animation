...
3. The tool projects those points toward a vanishing direction so the drawing can be previewed from different angles.
...
## Publishing notes
The repository is structured so it can be published as a simple open-source starter for a Krita perspective-guide workflow. The core logic is isolated in the Python module, making it straightforward to adapt into a full plugin later.